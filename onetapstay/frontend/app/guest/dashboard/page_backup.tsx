        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="card bg-gradient-to-br from-amber-50 to-yellow-50 border-amber-200">
              ...
              <Link href="/loyalty" className="btn-secondary w-full mt-4">
            ...
            <div className="card bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-semibold text-gray-900">Payment & Wallet</h2>
            ...
            <div className="card">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <span className="text-xs font-medium text-gray-900 text-center">WiFi</span>
                </Link>
                
                <Link href="/support" className="flex flex-col items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <button className="flex flex-col items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <span className="text-xs font-medium text-gray-900 text-center">Call</span>
                </button>
                ...
                <button className="flex flex-col items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <span className="text-xs font-medium text-gray-900 text-center">Email</span>
                </button>
              </div>
            </div>
          </div>

          {/* Right Content - Guest Info & Details */}
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center space-x-2">
                  <div className={`w-3 h-3 rounded-full ${guestProfile.booking.status === 'active' ? 'bg-green-500' : 'bg-yellow-500'}`}></div>
                  <span className="text-sm font-medium text-gray-600 capitalize">{guestProfile.booking.status}</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-lg font-semibold text-gray-900">{guestProfile.guestName}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 font-mono text-sm bg-gray-100 px-2 py-1 rounded">{guestProfile.bookingId}</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    <label className="text-sm font-medium text-gray-600">Room Details</label>
                    <p className="text-lg font-semibold text-gray-900">Room {guestProfile.booking.room.number}</p>
                    <p className="text-sm text-gray-600">{guestProfile.booking.room.type} • Floor {guestProfile.booking.room.floor}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-600">Stay Duration</label>
                    <p className="text-gray-900">
                      {new Date(guestProfile.booking.checkIn).toLocaleDateString()} - {new Date(guestProfile.booking.checkOut).toLocaleDateString()}
                    </p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-600">Guests</label>
                    <p className="text-gray-900">{guestProfile.booking.guests} guest{guestProfile.booking.guests !== 1 ? 's' : ''}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t pt-6 mt-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-medium text-gray-900">Digital Access</h3>
                  <Key className="h-5 w-5 text-gray-400" />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className={`p-4 rounded-lg border-2 ${guestProfile.accessInfo.roomKeyActive ? 'border-green-200 bg-green-50' : 'border-red-200 bg-red-50'}`}>
                    <div className="flex items-center space-x-3">
                      <div className={`w-3 h-3 rounded-full ${guestProfile.accessInfo.roomKeyActive ? 'bg-green-500' : 'bg-red-500'}`}></div>
                      <div>
                        <p className="font-medium text-gray-900">Room Key</p>
                        <p className={`text-sm ${guestProfile.accessInfo.roomKeyActive ? 'text-green-600' : 'text-red-600'}`}>
                          {guestProfile.accessInfo.roomKeyActive ? 'Active & Ready' : 'Inactive'}
                        </p>
                      </div>
                    </div>
                  </div>
                  
                  <div className={`p-4 rounded-lg border-2 ${guestProfile.accessInfo.wifiCredentialsAvailable ? 'border-blue-200 bg-blue-50' : 'border-gray-200 bg-gray-50'}`}>
                    <div className="flex items-center space-x-3">
                      <div className={`w-3 h-3 rounded-full ${guestProfile.accessInfo.wifiCredentialsAvailable ? 'bg-blue-500' : 'bg-gray-500'}`}></div>
                      <div>
                        <p className="font-medium text-gray-900">WiFi Access</p>
                        <p className={`text-sm ${guestProfile.accessInfo.wifiCredentialsAvailable ? 'text-blue-600' : 'text-gray-600'}`}>
                          {guestProfile.accessInfo.wifiCredentialsAvailable ? 'Credentials Ready' : 'Not Available'}
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                {guestProfile.accessInfo.digitalKeyExpiry && (
                  <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <p className="text-sm text-yellow-800">
                      <Clock className="h-4 w-4 inline mr-1" />
                      Digital key expires: {new Date(guestProfile.accessInfo.digitalKeyExpiry).toLocaleDateString()} at {new Date(guestProfile.accessInfo.digitalKeyExpiry).toLocaleTimeString()}
                    </p>
                  </div>
                )}
              </div>
            ...
            <div className="card">
              ...
              {journeyEvents.length > 0 ? (
                ...
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p className="text-lg font-medium">No Journey Events Yet</p>
                  <p className="text-sm">Your stay timeline will appear here as you use hotel services</p>
                </div>
              )}
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="card">
              ...
              <div className="text-center mb-4">
                <div className={`text-2xl font-bold mb-1 ${getTierColor(guestProfile.loyaltyPoints.tier)}`}>
                  {guestProfile.loyaltyPoints.tier}
                </div>
                <div className="text-3xl font-bold text-gray-900 mb-1">
                  {guestProfile.loyaltyPoints.current.toLocaleString()}
                </div>
                <div className="text-sm text-gray-600">Available Points</div>
              </div>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{guestProfile.loyaltyPoints.pointsToNextTier.toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Current Tier:</span>
                  <span className={`font-medium ${getTierColor(guestProfile.loyaltyPoints.tier)}`}>
                    {guestProfile.loyaltyPoints.tier}
                  </span>
                </div>
              </div>
              
              <Link href="/loyalty" className="btn-primary w-full mt-4">
                <Star className="h-4 w-4 mr-2" />
                View Rewards
              </Link>
            </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center p-3 border border-gray-200 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-gray-600">Visa ending in 4242</div>
                  </div>
                </div>
              </div>
              
              <Link href="/wallet" className="btn-secondary w-full mt-4">
            ...
            <div className="card">
              ...
              {journeyEvents.length > 0 ? (
                ...
                <div className="text-center py-6 text-gray-500">
                  ...
                  <p className="text-sm">Your journey timeline will appear here</p>
                </div>
              )}
            </div>
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-900">Hotel Facilities</h3>
              ...
              {facilities.length > 0 ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {facilities.map((facility) => (
                    <div key={facility.id} className="border border-gray-200 rounded-lg p-3 hover:bg-gray-50 transition-colors">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {facility.services && facility.services.length > 0 && (
                            <p className="text-xs text-gray-500 mt-1">
                              {facility.services.length} service{facility.services.length !== 1 ? 's' : ''} available
                            </p>
                          )}
                        </div>
                      </div>
