      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="card mb-8 bg-gradient-to-r from-primary-50 to-blue-50 border-primary-200">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            ...
            {/* Room Info */}
            <div>
              <h4 className="font-medium text-gray-900 mb-2">Room {guestProfile.booking.room.number}</h4>
              <div className="space-y-1 text-sm text-gray-600">
                <p>{guestProfile.booking.room.type} • Floor {guestProfile.booking.room.floor}</p>
                <p>{guestProfile.booking.guests} guests • {guestProfile.booking.room.beds} beds</p>
                <p className="font-mono text-xs bg-gray-100 px-2 py-1 rounded">
                  ID: {guestProfile.bookingId}
                </p>
              </div>
            </div>
            ...
            {/* Stay Dates */}
            <div>
              <h4 className="font-medium text-gray-900 mb-2">Stay Duration</h4>
              <div className="space-y-1 text-sm text-gray-600">
                <div className="flex items-center">
                  <Calendar className="h-4 w-4 mr-2" />
                  {new Date(guestProfile.booking.checkIn).toLocaleDateString()}
                </div>
                <div className="flex items-center">
                  <Calendar className="h-4 w-4 mr-2" />
                  {new Date(guestProfile.booking.checkOut).toLocaleDateString()}
                </div>
