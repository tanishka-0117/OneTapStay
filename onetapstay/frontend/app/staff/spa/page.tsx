...
import { Flower2, TrendingUp, Users, DollarSign, Clock } from 'lucide-react'
...
export default function SpaDashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const transactionsResponse = await fetch('http://localhost:5000/api/facility/transactions?facility=spa&limit=10', {
        headers: {
      ...
      // Fetch stats
      const statsResponse = await fetch('http://localhost:5000/api/facility/stats?facility=spa', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  return (
    <StaffLayout facilityName="Spa & Wellness" facilityType="spa">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Today's Treatments</p>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">{stats.activeGuests}</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            {isLoading ? (
              ...
              <div className="text-center py-8 text-gray-500">
                <Flower2 className="h-12 w-12 mx-auto mb-4 opacity-50" />
