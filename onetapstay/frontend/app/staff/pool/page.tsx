...
import { Waves, TrendingUp, Users, DollarSign, Clock } from 'lucide-react'
...
export default function PoolDashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const transactionsResponse = await fetch('http://localhost:5000/api/facility/transactions?facility=pool&limit=10', {
        headers: {
      ...
      // Fetch stats
      const statsResponse = await fetch('http://localhost:5000/api/facility/stats?facility=pool', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  return (
    <StaffLayout facilityName="Pool Bar" facilityType="pool">
