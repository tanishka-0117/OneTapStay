...
import { Dumbbell, TrendingUp, Users, DollarSign, Clock } from 'lucide-react'
...
export default function GymDashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const transactionsResponse = await fetch('http://localhost:5000/api/facility/transactions?facility=gym&limit=10', {
        headers: {
      ...
      // Fetch stats
      const statsResponse = await fetch('http://localhost:5000/api/facility/stats?facility=gym', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  return (
    <StaffLayout facilityName="Fitness Center" facilityType="gym">
